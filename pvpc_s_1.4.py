...
print("ejecucion real: ", datetime.datetime.now())
# Ejemplo de uso
...
ruta_absoluta_csv = f"/home/alfonso/data/{fecha_actual}/precios_luz_{fecha_actual}.csv"
ruta_absoluta_json = f"/home/alfonso/data/{fecha_actual}/precios_luz_{fecha_actual}.json"
